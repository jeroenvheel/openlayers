...
// which would cause float32 precision loss in the shader without CPU-side modular reduction.
const cx = 1113195;
const cy = 6446275;
...
// With CPU-side modular reduction, we should see a clean, tiled checkerboard.
...
map.once('rendercomplete', () => {
  render({
    message:
      'renders fill pattern correctly at zoom 23 (CPU-side modular reduction)',
    tolerance: 0.01,
  });
});
